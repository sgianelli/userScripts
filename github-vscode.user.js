...
(() => {
  ...
  const copyIcon = (width, height) => `
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="octicon octicon-clippy d-inline-block mx-1 js-clipboard-clippy-icon" clip-rule="evenodd" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="1.41421" width="${width}px" height="${height}px" viewBox="0 0 256 258">
